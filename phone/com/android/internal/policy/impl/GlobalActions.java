    ...
    private AlertDialog createDialog() {
        ...
        mItems = Lists.newArrayList(
                ...
                new SinglePressAction(com.android.internal.R.drawable.ic_lock_power_off, R.string.global_action_reboot) {
                    ...
                    public void onPress() {
                        ShutdownThread.reboot(mContext, null, (Settings.System.getInt(mContext.getContentResolver(), Settings.System.POWER_DIALOG_PROMPT, 1) == 1));
                    }
                ...
                new SinglePressAction(
                    ...
                    public void onPress() {
                        ShutdownThread.shutdown(mContext, (Settings.System.getInt(mContext.getContentResolver(), Settings.System.POWER_DIALOG_PROMPT, 1) == 1));
                    }
